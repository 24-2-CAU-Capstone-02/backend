...
public class MenuController {
    ...
    public ResponseEntity<Void> choiceMenu(@PathVariable String menuId, @Valid @RequestBody MenuChoiceRequest request) {
    ...
    @PatchMapping("/{menuId}")
    public ResponseEntity<MenuResponse> updateMenu(@PathVariable String menuId, @Valid @RequestBody MenuUpdateRequest request) {
        Menu menu = menuService.getMenuById(menuId);
    ...
    public ResponseEntity<Void> deleteMenu(@PathVariable String menuId, @Valid @RequestBody MenuDeleteRequest request) {
        Menu menu = menuService.getMenuById(menuId);
