...
public class RoomController {
    ...
    public ResponseEntity<List<MenuResponse>> getMenuList(@PathVariable String roomId) {
        Room room = roomService.getRoomById(roomId);
    ...
    public ResponseEntity<Void> uploadMenuBoardImage(@PathVariable String roomId, @Valid @RequestBody MenuImageUploadRequest request) {
        Room room = roomService.getRoomById(roomId);
    ...
    public ResponseEntity<TokenResponse> addMember(@PathVariable String roomId, @Valid @RequestBody RoomAddMemberRequest request) {
        Room room = roomService.getRoomById(roomId);
    ...
    public ResponseEntity<Void> shareRoomMenu(@PathVariable String roomId, @Valid @RequestBody ShareRoomMenuRequest request) {
        Room room = roomService.getRoomById(roomId);
    ...
    public ResponseEntity<MenuResponse> addMenu(@PathVariable String roomId, @Valid @RequestBody MenuCreateRequest request) {
        Room room = roomService.getRoomById(roomId);
