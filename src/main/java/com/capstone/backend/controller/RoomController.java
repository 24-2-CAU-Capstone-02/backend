...
public class RoomController {
    ...
    public ResponseEntity<List<MenuResponse>> getMenuList(@PathVariable UUID roomId) {
        Room room = roomService.getRoomById(roomId);
    ...
    public ResponseEntity<List<MenuImageResponse>> getMenuImageList(@PathVariable UUID roomId) {
        Room room = roomService.getRoomById(roomId);
    ...
    public ResponseEntity<Void> uploadMenuBoardImage(@PathVariable UUID roomId, @Valid @RequestBody MenuImageUploadRequest request) {
        Room room = roomService.getRoomById(roomId);
    ...
    public ResponseEntity<Void> uploadMenuBoardImageInFormData(@PathVariable UUID roomId, @RequestParam("images") List<MultipartFile> images) {
        Room room = roomService.getRoomById(roomId);
    ...
    public ResponseEntity<TokenResponse> addMember(@PathVariable UUID roomId, @Valid @RequestBody RoomAddMemberRequest request) {
        Room room = roomService.getRoomById(roomId);
    ...
    public ResponseEntity<MenuResponse> addMenu(@PathVariable UUID roomId, @Valid @RequestBody MenuCreateRequest request) {
        Room room = roomService.getRoomById(roomId);
